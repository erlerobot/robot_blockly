...
try:
    ...
    print "Cannot get ros package path, has blockly been launched?"

robot_blockly_package = rospack.get_path("robot_blockly")

os.chdir(robot_blockly_package + "/frontend/blockly")
...
class Gen_compressed(threading.Thread):
    ...
    def gen_generator(self, language):
        ...
        filenames.insert(0, os.path.join(self.package_paths[0], "generators", language + ".js"))
        for filename in filenames:
            f = open(filename)
            params.append(("js_code", "".join(f.readlines())))
            f.close()
